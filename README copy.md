...
CREATE TABLE USUARIO (
    ...
    const userInsert = await AppDataSource.query("INSERT INTO USUARIO (cpfcnpj, nome, telefone, rua, bairro, cidade, nro_conta) VALUES($1,$2,$3,$4,$5,$6,$7) returning id", [
        userData.cpfcnpj, 
        userData.nome,
        userData.telefone,
        userData.rua,
...
CREATE TABLE CHAVE_PIX (
	CHAVE VARCHAR(100) UNIQUE PRIMARY KEY,
	TIPO VARCHAR(20),
...
CREATE TABLE TRANSACAO (
	...
	CHAVE_DESTINO VARCHAR(100) NOT NULL,
	FOREIGN KEY  (CHAVE_ORIGEM) REFERENCES CHAVE_PIX(CHAVE),
	FOREIGN KEY  (CHAVE_DESTINO) REFERENCES CHAVE_PIX(CHAVE)
);


# ACESSO AO POSTGRES DB
DB_HOST = localhost
DB_PORT = 5432
DB_USER = postgres
